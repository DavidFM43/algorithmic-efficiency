...
class BaseSennetWorkload(spec.Workload):
  ...
  def has_reached_validation_target(self, eval_result: Dict[str, float]) -> bool:
    return eval_result['validation/surface_dice'] > self.validation_target_value
  ...
  def has_reached_test_target(self, eval_result: Dict[str, float]) -> bool:
    return eval_result['test/surface_dice'] > self.test_target_value
  ...
  def encoder_name(self) -> str:
    return "timm-mobilenetv3_small_075"
  ...
  @property
  def encoder_weights(self) -> Optional[str]:
    return None
